            ...
            <div className="row justify-content-center">             
                ...
                <div className="col-12 col-sm-4 align-self-center">
                    <div className="text-center">
                        ...
                        <a className="btn btn-social-icon btn-twitter" href="http://twitter.com/"><i class="fa-brands fa-square-twitter"></i></a>
                        <a className="btn btn-social-icon btn-google" href="http://youtube.com/"><i class="fa-brands fa-youtube"></i></a>
                        <a className="btn btn-social-icon" href="mailto:"><i class="fa-solid fa-envelope"></i></a>
                    </div>
                </div>
            </div>
            <div className="row justify-content-center">             
