...
class Header extends Component {
    constructor(props) {
        ...
        this.toggleModel = this.toggleModal.bind(this);
            ...
            <div>
                <Navbar dark expand="md">
                    <div className="container same">
                        ...
                        <NavbarBrand className="mt-auto" href="/"><img src='assets/images/logo.png' height="30" width="41" alt='Ristorante Con Fusion' /></NavbarBrand>
